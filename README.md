go-chart
========
[![Build Status](https://travis-ci.org/juangnakarani/go-chart.svg?branch=master)](https://travis-ci.org/juangnakarani/go-chart)[![Go Report Card](https://goreportcard.com/badge/github.com/juangnakarani/go-chart)](https://goreportcard.com/report/github.com/juangnakarani/go-chart)
...
```bash
> go get -u github.com/juangnakarani/go-chart
```
...
![](https://raw.githubusercontent.com/juangnakarani/go-chart/master/_images/tvix_ltm.png)

Single axis:

![](https://raw.githubusercontent.com/juangnakarani/go-chart/master/_images/goog_ltm.png)

Two axis:

![](https://raw.githubusercontent.com/juangnakarani/go-chart/master/_images/two_axis.png)

# Other Chart Types

Pie Chart:

![](https://raw.githubusercontent.com/juangnakarani/go-chart/master/_images/pie_chart.png)

The code for this chart can be found in `_examples/pie_chart/main.go`.

Stacked Bar:

![](https://raw.githubusercontent.com/juangnakarani/go-chart/master/_images/stacked_bar.png)
...
import (
    ...
    "bytes"
    ...
    "github.com/juangnakarani/go-chart" //exposes "chart"
)
